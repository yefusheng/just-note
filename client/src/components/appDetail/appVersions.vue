  ...
  <div class="appVersion-wrapper">
    ...
    <div v-if="this.dataArr.length>0">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <button class="appversion-elButton " @click="releaseApp(scope.row)"><i class="icon-ic_overview"></i> </button><span @click="releaseApp(scope.row)">发布</span>
            <button class="appversion-elButton" @click="clickDownLoad(scope.row)"><i class="icon-ic_download"></i></button><span @click="clickDownLoad(scope.row)">下载</span>
            <button class="appversion-elButton" @click="clickEditor(scope.row)"><i class="icon-ic_edit"></i></button><span @click="clickEditor(scope.row)">编辑</span>
            <button class="appversion-elButton" @click="clickDelect(scope.row)"><i class="icon-ic_delete"></i></button><span @click="clickEditor(scope.row)">删除</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      getCreatTime(date) {
        ...
        return utils.dateFtt('yyyy-MM-dd hh:mm:ss',releaseDate);
      },
      getAppSize(size) {
