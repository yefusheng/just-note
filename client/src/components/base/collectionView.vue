        ...
        <div class="appItem-info">
          ...
          <table style="width: 100%;table-layout: fixed;margin-top: 24px">
            ...
            <tr>
              ...
              <td>
                <div class="appItem-info-appInfo nowrap" v-if="item.platform=='android'" v-html="item.currentVersionName"></div>
                <div class="appItem-info-appInfo nowrap" v-if="item.platform!='android'" v-html="item.currentVersion"></div>
              </td>
            </tr>
        </table>
        </div>
